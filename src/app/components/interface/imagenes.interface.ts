// To parse this data:
//
//   import { Convert, SearchImagenesResponse } from "./file";
//
//   const searchImagenesResponse = Convert.toSearchImagenesResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchImagenesResponse {
    data:       imagenes[];
...
export class Convert {
    public static toSearchImagenesResponse(json: string): SearchImagenesResponse {
        return cast(JSON.parse(json), r("SearchImagenesResponse"));
    }

    public static searchImagenesResponseToJson(value: SearchImagenesResponse): string {
        return JSON.stringify(uncast(value, r("SearchImagenesResponse")), null, 2);
    }
}
